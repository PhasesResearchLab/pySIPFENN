...
def profile(test='JVASP-10001'):
    ...
    if test == 'JVASP-10001':
        ...
        matStr = '{"@module": "pymatgen.core.structure", "@class": "Structure", "charge": null, "lattice": {"matrix": ' \
                 '[[4.599305652662459, 0.0098015076998823, 3.1052612865443736], [1.6553257726204653, ' \
                 '4.291108475854712, 3.1052602938979565], [0.0142541214919749, 0.0098025099996131, ' \
                 '5.549419141866351]], "a": 5.549446478152326, "b": 5.549446536179343, "c": 5.549446105810423, ' \
                 '"alpha": 55.82714459985832, "beta": 55.82714014289371, "gamma": 55.82713972779092, ' \
                 '"volume": 109.15484625642743}, "sites": [{"species": [{"element": "Li", "occu": 1.0}], ' \
                 '"abc": [0.2738784872669924, 0.2738784872670407, 0.2738784872673032], "xyz": [1.7169128904007063, ' \
                 '1.1806114167777613, 3.220794775377278], "label": "Li", "properties": {}}, {"species": [{"element": ' \
                 '"Li", "occu": 1.0}], "abc": [0.7852272010728069, 0.7852272010728856, 0.785227201073315], ' \
                 '"xyz": [4.922499451739965, 3.3848887059434927, 9.234225338163633], "label": "Li", "properties": {' \
                 '}}, {"species": [{"element": "O", "occu": 1.0}], "abc": [0.8669964454661124, 0.604089882092114, ' \
                 '0.241821769873143], "xyz": [4.990994160164061, 2.603083545876856, 5.910077181137658], "label": "O", ' \
                 '"properties": {}}, {"species": [{"element": "O", "occu": 1.0}], "abc": [0.717840894529788, ' \
                 '0.1213675889628683, 0.393537009186973], "xyz": [3.508082106234713, 0.531695063215412, ' \
                 '4.789863306469278], "label": "O", "properties": {}}, {"species": [{"element": "O", "occu": 1.0}], ' \
                 '"abc": [0.1213675889638402, 0.3935370091873943, 0.7178408945283384], "xyz": [1.2198707830817896, ' \
                 '1.6969362235910317, 5.58251292516964], "label": "O", "properties": {}}, {"species": [{"element": ' \
                 '"O", "occu": 1.0}], "abc": [0.3935370091861915, 0.7178408945293856, 0.1213675889634014], ' \
                 '"xyz": [2.999987512595622, 3.085380109860344, 4.124637687962297], "label": "O", "properties": {}}, ' \
                 '{"species": [{"element": "O", "occu": 1.0}], "abc": [0.2418217698721573, 0.8669964454671221, ' \
                 '0.6040898820921513], "xyz": [2.555984564633329, 3.728667610729149, 6.795517372377343], ' \
                 '"label": "O", "properties": {}}, {"species": [{"element": "O", "occu": 1.0}], ' \
                 '"abc": [0.6040898820933115, 0.2418217698723637, 0.8669964454664059], "xyz": [3.191046090145173, ' \
                 '1.0521031793025595, 7.4381031350436535], "label": "O", "properties": {}}, {"species": [{"element": ' \
                 '"Te", "occu": 1.0}], "abc": [0.4965905610507353, 0.4965905610507355, 0.4965905610507361], ' \
                 '"xyz": [3.113069390835793, 2.1406591357024984, 5.8398755612146624], "label": "Te", "properties": {' \
                 '}}, {"species": [{"element": "Zr", "occu": 1.0}], "abc": [0.0006501604980668, 0.0006501604980928, ' \
                 '0.0006501604982344], "xyz": [0.00407578174946036, 0.002802654981945192, 0.007645848918263076], ' \
                 '"label": "Zr", "properties": {}}]}'
    elif test == 'diluteNiAlloy':
        print('Profiling/testing task. Will calculate a descriptor for a dilute FCC Ni31Cr1.')
        matStr = '{"@module": "pymatgen.core.structure", "@class": "Structure", "charge": null, "lattice": {"matrix": ' \
                 '[[6.995692, 0.0, 0.0], [0.0, 6.995692, 0.0], [0.0, 0.0, 6.995692]], "a": 6.995692, "b": 6.995692, ' \
                 '"c": 6.995692, "alpha": 90.0, "beta": 90.0, "gamma": 90.0, "volume": 342.36711365619243}, ' \
                 '"sites": [{"species": [{"element": "Cr", "occu": 1}], "abc": [0.0, 0.0, 0.0], "xyz": [0.0, 0.0, ' \
                 '0.0], "label": "Cr", "properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.0, ' \
                 '0.0, 0.5], "xyz": [0.0, 0.0, 3.497846], "label": "Ni", "properties": {}}, {"species": [{"element": ' \
                 '"Ni", "occu": 1}], "abc": [0.0, 0.5, 0.0], "xyz": [0.0, 3.497846, 0.0], "label": "Ni", ' \
                 '"properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.0, 0.5, 0.5], "xyz": [0.0, ' \
                 '3.497846, 3.497846], "label": "Ni", "properties": {}}, {"species": [{"element": "Ni", "occu": 1}], ' \
                 '"abc": [0.5, 0.0, 0.0], "xyz": [3.497846, 0.0, 0.0], "label": "Ni", "properties": {}}, {"species": ' \
                 '[{"element": "Ni", "occu": 1}], "abc": [0.5, 0.0, 0.5], "xyz": [3.497846, 0.0, 3.497846], ' \
                 '"label": "Ni", "properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.5, 0.5, ' \
                 '0.0], "xyz": [3.497846, 3.497846, 0.0], "label": "Ni", "properties": {}}, {"species": [{"element": ' \
                 '"Ni", "occu": 1}], "abc": [0.5, 0.5, 0.5], "xyz": [3.497846, 3.497846, 3.497846], "label": "Ni", ' \
                 '"properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.25, 0.25, 0.0], ' \
                 '"xyz": [1.748923, 1.748923, 0.0], "label": "Ni", "properties": {}}, {"species": [{"element": "Ni", ' \
                 '"occu": 1}], "abc": [0.25, 0.25, 0.5], "xyz": [1.748923, 1.748923, 3.497846], "label": "Ni", ' \
                 '"properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.25, 0.7500000000000001, ' \
                 '0.0], "xyz": [1.748923, 5.2467690000000005, 0.0], "label": "Ni", "properties": {}}, {"species": [{' \
                 '"element": "Ni", "occu": 1}], "abc": [0.25, 0.7500000000000001, 0.5], "xyz": [1.748923, ' \
                 '5.2467690000000005, 3.497846], "label": "Ni", "properties": {}}, {"species": [{"element": "Ni", ' \
                 '"occu": 1}], "abc": [0.7500000000000001, 0.25, 0.0], "xyz": [5.2467690000000005, 1.748923, 0.0], ' \
                 '"label": "Ni", "properties": {}}, {"species": [{"element": "Ni", "occu": 1}], ' \
                 '"abc": [0.7500000000000001, 0.25, 0.5], "xyz": [5.2467690000000005, 1.748923, 3.497846], ' \
                 '"label": "Ni", "properties": {}}, {"species": [{"element": "Ni", "occu": 1}], ' \
                 '"abc": [0.7500000000000001, 0.7500000000000001, 0.0], "xyz": [5.2467690000000005, ' \
                 '5.2467690000000005, 0.0], "label": "Ni", "properties": {}}, {"species": [{"element": "Ni", ' \
                 '"occu": 1}], "abc": [0.7500000000000001, 0.7500000000000001, 0.5], "xyz": [5.2467690000000005, ' \
                 '5.2467690000000005, 3.497846], "label": "Ni", "properties": {}}, {"species": [{"element": "Ni", ' \
                 '"occu": 1}], "abc": [0.25, 0.0, 0.25], "xyz": [1.748923, 0.0, 1.748923], "label": "Ni", ' \
                 '"properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.25, 0.0, ' \
                 '0.7500000000000001], "xyz": [1.748923, 0.0, 5.2467690000000005], "label": "Ni", "properties": {}}, ' \
                 '{"species": [{"element": "Ni", "occu": 1}], "abc": [0.25, 0.5, 0.25], "xyz": [1.748923, 3.497846, ' \
                 '1.748923], "label": "Ni", "properties": {}}, {"species": [{"element": "Ni", "occu": 1}], ' \
                 '"abc": [0.25, 0.5, 0.7500000000000001], "xyz": [1.748923, 3.497846, 5.2467690000000005], ' \
                 '"label": "Ni", "properties": {}}, {"species": [{"element": "Ni", "occu": 1}], ' \
                 '"abc": [0.7500000000000001, 0.0, 0.25], "xyz": [5.2467690000000005, 0.0, 1.748923], "label": "Ni", ' \
                 '"properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.7500000000000001, 0.0, ' \
                 '0.7500000000000001], "xyz": [5.2467690000000005, 0.0, 5.2467690000000005], "label": "Ni", ' \
                 '"properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.7500000000000001, 0.5, ' \
                 '0.25], "xyz": [5.2467690000000005, 3.497846, 1.748923], "label": "Ni", "properties": {}}, ' \
                 '{"species": [{"element": "Ni", "occu": 1}], "abc": [0.7500000000000001, 0.5, 0.7500000000000001], ' \
                 '"xyz": [5.2467690000000005, 3.497846, 5.2467690000000005], "label": "Ni", "properties": {}}, ' \
                 '{"species": [{"element": "Ni", "occu": 1}], "abc": [0.0, 0.25, 0.25], "xyz": [0.0, 1.748923, ' \
                 '1.748923], "label": "Ni", "properties": {}}, {"species": [{"element": "Ni", "occu": 1}], ' \
                 '"abc": [0.0, 0.25, 0.7500000000000001], "xyz": [0.0, 1.748923, 5.2467690000000005], "label": "Ni", ' \
                 '"properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.0, 0.7500000000000001, ' \
                 '0.25], "xyz": [0.0, 5.2467690000000005, 1.748923], "label": "Ni", "properties": {}}, {"species": [{' \
                 '"element": "Ni", "occu": 1}], "abc": [0.0, 0.7500000000000001, 0.7500000000000001], "xyz": [0.0, ' \
                 '5.2467690000000005, 5.2467690000000005], "label": "Ni", "properties": {}}, {"species": [{"element": ' \
                 '"Ni", "occu": 1}], "abc": [0.5, 0.25, 0.25], "xyz": [3.497846, 1.748923, 1.748923], "label": "Ni", ' \
                 '"properties": {}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.5, 0.25, ' \
                 '0.7500000000000001], "xyz": [3.497846, 1.748923, 5.2467690000000005], "label": "Ni", "properties": ' \
                 '{}}, {"species": [{"element": "Ni", "occu": 1}], "abc": [0.5, 0.7500000000000001, 0.25], ' \
                 '"xyz": [3.497846, 5.2467690000000005, 1.748923], "label": "Ni", "properties": {}}, {"species": [{' \
                 '"element": "Ni", "occu": 1}], "abc": [0.5, 0.7500000000000001, 0.7500000000000001], ' \
                 '"xyz": [3.497846, 5.2467690000000005, 5.2467690000000005], "label": "Ni", "properties": {}}], ' \
                 '"@version": null}'
    else:
