.. pySIPFENN documentation master file, created by
   sphinx-quickstart on Fri Feb  3 10:54:54 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to pySIPFENN's documentation!
=====================================
...
package allows efficient predictions of the energetics of
